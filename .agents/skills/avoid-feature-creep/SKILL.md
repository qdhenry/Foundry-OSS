...
**To AI agents (Codex, Opus, Codex, Ralph, Cursor):**
...
**Session Start Check:**
Before coding with any AI assistant (Codex, Cursor, OpenCode), state:
...
| 2025-01-17 | Add caching layer | Codex | Deferred | Premature optimization | Stay focused on core feature |
