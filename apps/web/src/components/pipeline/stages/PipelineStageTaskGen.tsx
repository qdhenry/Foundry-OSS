...
import { TaskDecompositionPanel } from "../../ai-features/TaskDecompositionPanel";
...
export function PipelineStageTaskGen({ requirement, programId, tasks }: PipelineStageTaskGenProps) {
  const latestDecomp = useQuery(api.taskDecomposition.getLatestDecomposition, {
    requirementId: requirement._id as Id<"requirements">,
  });
  const requestDecomposition = useMutation(api.taskDecomposition.requestDecomposition);
