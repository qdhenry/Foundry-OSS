...
import { type FileUploadStatus, useUploadQueue } from "@/hooks/useUploadQueue";
...
export function DiscoveryDocumentZone({
  ...
  const batchProgress = useQuery(api.documentAnalysis.getBatchProgress, {
    programId,
  });
  ...
  const categorizeDocument = useAction(api.documents.categorize);
      ...
      <div className="p-5">
        ...
        <div className="mt-5 flex flex-wrap items-center gap-2">
          ...
          <button
            ...
            className="rounded-lg border border-border-default px-3 py-1.5 text-xs font-medium text-text-primary hover:bg-interactive-hover disabled:opacity-60"
          >
                    ...
                    <Fragment key={document._id}>
                      <tr className="border-b border-border-default">
                        <td className="px-3 py-2 align-top">
                          <div className="flex items-center gap-2">
                            ...
                            {isVideo && (
                              <span className="rounded bg-surface-elevated px-1.5 py-0.5 text-[10px] font-semibold uppercase text-text-secondary">
                                Video
                              </span>
                            )}
                          </div>
                      ...
                      {isActive && (
                        <tr className="border-b border-status-info-border">
                          <td colSpan={5} className="bg-status-info-bg/50 px-3 py-2">
