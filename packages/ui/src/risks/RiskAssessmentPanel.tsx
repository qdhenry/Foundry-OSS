...
export function RiskAssessmentPanel({
  ...
  const data = useQuery("riskAutogeneration:getLatestAssessment" as any, {
    programId: programId as any,
  });
  const evaluateRisks = useMutation("riskAutogeneration:requestRiskEvaluation" as any);
  ...
  const assessment = data.assessment as {
    ...
    new_risks?: Array<{
      ...
      mitigation?:
        | string
        | { action?: string; effort?: string; expected_outcome?: string; priority?: string };
    }>;
    escalations?: Array<{
    ...
    recommendations?: Array<
      string | { action?: string; effort?: string; expected_outcome?: string; priority?: string }
    >;
  };
