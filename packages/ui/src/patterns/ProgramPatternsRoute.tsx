...
export function ProgramPatternsRoute() {
  ...
  if (!isAuthenticated) {
    return (
      <div className="card rounded-xl p-8">
        ...
        <p className="mt-2 text-sm text-text-secondary">Sign in to load patterns.</p>
      </div>
    );
  }
  ...
  if (!orgId) {
    return (
      <div className="card rounded-xl p-8">
        <h1 className="type-display-m text-text-heading">Pattern Library</h1>
        <p className="mt-2 text-sm text-text-secondary">Select an organization to load patterns.</p>
      </div>
    );
  }
  ...
  if (!programSlug) {
    return (
      <div className="card rounded-xl p-8">
        <h1 className="type-display-m text-text-heading">Pattern Library</h1>
        <p className="mt-2 text-sm text-text-secondary">Select a program to load patterns.</p>
      </div>
    );
  }
  ...
  return <PatternsPage programId={String(program._id)} programSlug={program.slug ?? programSlug} />;
}
