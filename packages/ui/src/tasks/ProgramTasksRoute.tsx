...
export function ProgramTasksRoute() {
  ...
  if (!isAuthenticated) {
    return (
      <div className="card rounded-xl p-8">
        ...
        <p className="mt-2 text-sm text-text-secondary">Sign in to load tasks.</p>
      </div>
    );
  }
  ...
  if (!orgId) {
    return (
      <div className="card rounded-xl p-8">
        <h1 className="type-display-m text-text-heading">Tasks</h1>
        <p className="mt-2 text-sm text-text-secondary">Select an organization to load tasks.</p>
      </div>
    );
  }
  ...
  if (!programSlug) {
    return (
      <div className="card rounded-xl p-8">
        <h1 className="type-display-m text-text-heading">Tasks</h1>
        <p className="mt-2 text-sm text-text-secondary">Select a program to load tasks.</p>
      </div>
    );
  }
  ...
  if (program === null) {
    return (
      <div className="card rounded-xl p-8">
        <h1 className="type-display-m text-text-heading">Tasks</h1>
        <p className="mt-2 text-sm text-text-secondary">Program not found for this route.</p>
      </div>
    );
  }

  return <TasksPage programId={String(program._id)} programSlug={program.slug ?? programSlug} />;
}
