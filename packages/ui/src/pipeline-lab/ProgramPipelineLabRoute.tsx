...
export function ProgramPipelineLabRoute() {
  ...
  if (!isAuthenticated) {
    return (
      <div className="card rounded-xl p-8">
        ...
        <p className="mt-2 text-sm text-text-secondary">Sign in to load pipeline lab.</p>
      </div>
    );
  }
    ...
    return (
      <div className="card rounded-xl p-8">
        ...
        <p className="mt-2 text-sm text-text-secondary">
          Select an organization to load pipeline lab.
        </p>
      </div>
    );
  }
  ...
  if (!programSlug) {
    return (
      <div className="card rounded-xl p-8">
        <h1 className="type-display-m text-text-heading">Pipeline Lab</h1>
        <p className="mt-2 text-sm text-text-secondary">Select a program to load pipeline lab.</p>
      </div>
    );
  }
  ...
  return (
    <PipelineLabPage programId={String(program._id)} programSlug={program.slug ?? programSlug} />
  );
}
